...
namespace TB_QuestGame
{
    ...
    public static class ConsoleLayout
    {
        ...
        public static int HeaderWidth = 100;
        ...
        public static int FooterWidth = 100;
        ...
        //
        public static int MenuBoxWidth = 25;
        public static int MenuBoxHeight = 25;
        public static int MenuBoxPositionLeft = 74;
        public static int MenuBoxPositionTop = 3;

        //
        // message box configuration
        //
        public static int MessageBoxWidth = 73;
        ...
        //
        public static int InputBoxWidth = 98;
